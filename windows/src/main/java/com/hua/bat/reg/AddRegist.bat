@ rem ----- 信息 -----
@ rem @filename AddRegist.bat
@ rem @version 1.0
@ rem @author qye.zheng
@ rem @description 添加注册表数据
...
@ rem reg add HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run /v HiJson2 /d "C:\Users\admin\Desktop\HiJson 2.1.2_jdk164.exe"
@ rem ----- 程序设计区
